...
public class Edit_API extends AppCompatActivity {
    private EditText edt_name, edt_age, edt_address, edt_phone,edt_date;
    private CircleImageView mPicture;
    private FloatingActionButton mFabChoosePic;
    Calendar myCalendar = Calendar.getInstance();
    private Bitmap bitmap;
    private String name, age, address, phone, birth,picture;
    private int id;
    private Menu action;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edt_age = findViewById(R.id.ed_std_age);
...
// Chế độ đọc
    ...
    private void postData(final String key) {
       ...
       // Gọi API_interface
        ...
        Call<Staff> call = apiInterface.insertStudent( key, name, age, address,phone, birth, image);
...
// Gọi Hàm Call Back đẩy dữ liệu lên host thông qua API interface
        Call<Staff> call = apiInterface.update_student( key,id, name, age, address,phone, birth, image);
        call.enqueue(new Callback<Staff>() {
            @Override
            public void onResponse(Call<Staff> call, Response<Staff> response) {
                progressDialog.dismiss();
...
// Gọi API interface
        apiInterface = ApiClient.getApiClient().create(Api_Interface.class);
// Gọi hàm Call back đẩy dữ liệu lên host thông qua Api interface
        Call<Staff> call = apiInterface.delete_Student(key, id, pic);
        call.enqueue(new Callback<Staff>() {
            @Override
            public void onResponse(Call<Staff> call, Response<Staff> response) {
                progressDialog.dismiss();
